...
template<typename T>
class SparseMatrix : public std::map<int, SparseVector<T> > {
public:
    T get(int x, int y);
...
template<typename T>
class SparseTensor : public std::map<int, SparseMatrix<T> > {
public:
...
template<typename T>
void SparseVector<T>::toStream(std::ostream &stream) {
...
template<typename T>
void SparseMatrix<T>::toStream(std::ostream &stream) {
...
template<typename T>
T SparseTensor<T>::get(int x, int y, int z) {
...
template<typename T>
void SparseTensor<T>::toStream(std::ostream &stream) {
...
template<typename T>
void SparseTensor<T>::toFile(const std::string &filename) {
...
template<typename T>
void SparseTensor<T>::fromFile(const std::string &filename) {
...
template<typename T>
void SparseMatrix<T>::fromFile(const std::string &filename) {
    std::ifstream fData(filename.c_str());
    if (!fData.is_open()) {
        throw "Unable to open file " + filename;
    }
